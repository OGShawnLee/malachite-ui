...
describe.skip('isActionComponent', () => {
	it.skip('Should return true if value has correct ActionComponent shape and prop types', () => {
		expect(isActionComponent({ Proxy: new Bridge(), action: () => 360 })).toBe(true);
	});

	it.skip('Should return false if value is missing keys', () => {
	...
	it.skip('Should return false if value has correct keys but wrong types', () => {
	...
	it.skip('Should return false if value has correct keys but not all keys have correct type', () => {
	...
	it.skip('Should handle non object and falsy values by returning false', () => {
